...
const audioTracks = [
    {
        ...
        duration: "2:56",
        src: "I Love You(KoshalWorld.Com).mp3"  // Update this path
    },
    {
        title: "Celebration Time",
        artist: "Party Hits",
        duration: "3:57",
        src: "Sapphire (Mp3 Song)-(SambalpuriStar.In).mp3"  // Update this path
    },
    {
        title: "Love Anthem",
        artist: "Birthday Beats",
        duration: "2:45",
        src: "Shawn Mendes, Camila Cabello - Señorita.mp3"  // Update this path
    }
];
